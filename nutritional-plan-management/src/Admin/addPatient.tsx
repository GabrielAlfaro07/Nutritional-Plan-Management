...
const AddPatient = () => {
    ...
    return (
      <div>
        ...
        <PatientForm formData={formData} setFormData={setFormData} savePatientData={savePatientData} editableFields={['name', 'lastname1', 'lastname2','age', 'mail', 'birthdate','startdate', 'phoneNumber', 'goal']}  />
      </div>
    );
  };
