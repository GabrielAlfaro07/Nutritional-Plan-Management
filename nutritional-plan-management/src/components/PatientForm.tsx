...
const PatientForm: React.FC<PatientFormProps> = ({ formData, setFormData, savePatientData, editableFields }) => {
  ...
  return (
    <form className="text-center p-10 bg-white bg-opacity-80 rounded-lg shadow-lg" onSubmit={handleSubmit}>
      <div className="mb-4">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={(e) => formData && setFormData({ ...formData, birthdate: e.target.value })}
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={(e) => formData && setFormData({ ...formData, startdate: e.target.value })}
      ...
      <div>
        <button className="bg-blue-500 text-white p-2 rounded-lg hover:bg-blue-700" type="submit" disabled={editableFields.length === 0 || !formData}>
          Guardar
        </button>
      </div>
    </form>
